...
class Message extends Model {
	 ...
	 * @var array
	 */
	protected $fillable = [ 'user_id' , 'user_ip' , 'campaign_id' , 'widget_id' , 'name' , 'email' , 'phone' , 'is_readed' , 'is_archived', 'consent' , 'url' , 'file_name' , 'duration' , 'file_type' , 'is_complete', 'youtube_url' , 'created_at', 'browser_and_version', 'os_and_version', 'screen_size', 'mobile' ];
