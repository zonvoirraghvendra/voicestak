            ...
            <div class='vt-content'>
                ...
                <div class='vt-inbox-box-controller'>
                    <form action="/messages/{!! $message->id !!}" method="POST">
                        ...
                        @endif
                        <a href="javascript:void(0);" data-target="#shareModal{!! $message->id !!}" data-toggle='modal' class="btn btn-info" @if($message->file_name && $message->file_type == 'audio') flink="{!! $message->file_name !!}" download @elseif($message->file_name && $message->file_type == 'video') flink="/uploads/video/{!! $message->file_name !!}" download @else flink="javascript:;" @endif class="btn btn-info" title="Share this message">
                        ...
                        <div class="modal fade" id="shareModal{!! $message->id !!}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            ...
                            <div class="modal-body" id="embcode{!! $message->id !!}">
                                    ...
                                    &lt;iframe width="560" height="315" src="{!! $message->file_name !!}" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen&gt;
                                    &lt;/iframe&gt;
                                
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                <button type="button" class="btn btn-primary copytn" msgid="{!! $message->id !!}">Copy</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        $(".copytn").click(function(){
               //alert($("#embcode"+$(this).attr('msgid')).html()); return false;
                var $temp = $("<input>");
                 $temp.val($("#embcode"+$(this).attr('msgid')).text());
