<script>
	$( document ).ready(function() {
		@if(isset($widget) && $widget->tab_bg_color != '')
			...
			$('.widget-footer-5').css({'box-shadow': 'inset 0 -10px 10px '+NewColor});
		@endif
	})
</script>

<div class="widget-footer-5 widget-footer-5-media" @if(isset($widget)) style="background-color: {!! $widget->tab_bg_color !!}" @endif>
