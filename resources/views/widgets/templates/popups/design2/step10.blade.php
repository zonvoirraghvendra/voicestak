<div style="display: none;" class="display_div d2">
    <div id="popup16" class="lightbox" @if(isset($widget)) style="background-color: {!! $widget->widget_bg_color !!}" @endif>
        <section class="popup popup-five popup16">
            ...
            <div>
                <h4 id="done-processing-heading">Your video is processing, it may take up to 60 seconds to load preview</h4>
            </div>
            <div>
            ...
            @else
                <div class="recording-box"><video type="video/mp4" playsinline id="video_watch" style="width: 400px !important; height: 270px !important;" preload="auto">
