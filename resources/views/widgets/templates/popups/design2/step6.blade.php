<div style="display: none;" class="display_div d2">
        ...
        <div id="popup22" class="lightbox voice_subscribe_popup" @if(isset($widget)) style="background-color: {!! $widget->widget_bg_color !!}" @endif>
    ...
    @if(isset($widget))
        {!! '<style>.popup-video .text-field { border-color: ' .$widget->widget_buttons_bg_color . ' !important} </style>' !!}
    @endif
</div>