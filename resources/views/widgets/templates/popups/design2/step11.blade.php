<div style="display: none;" class="display_div d2" id="ar_form">
        ...
        <div id="popup17" class="lightbox video_subscribe_popup" @if(isset($widget)) style="background-color: {!! $widget->widget_bg_color !!}" @endif>
            <section class="popup popup-six popup-video popup17">
                <h2 class="border" @if(isset($widget)) style="background-color: {!! $widget->widget_main_headline_bg_color !!} ; border-color: {!! $widget->widget_buttons_bg_color !!} ; color: {!! $widget->widget_main_headline_color !!}" @endif>Send Us a Video Message</h2>
                    ...
                    <fieldset>
                        ...
                        <div class="btn-holder">
                            @if((isset($widget) && isset($widget->phone_field_active) && $widget->phone_field_active == 0) && ( (isset($widget) && !empty($widget->rawhtml_form_action)) || (isset($widget) && !empty($widget->email_provider) && !empty($widget->email_provider_value)) ))
                                <button type="submit" class="btn-send" id="validate_inputs_video"><span @if(isset($widget)) style="background-color: {!! $widget->widget_buttons_bg_color !!} ; color: {!! $widget->widget_buttons_text_color !!} !important;" @endif>Send</span></button>
                            @elseif((isset($widget) && isset($widget->phone_field_active) && $widget->phone_field_active == 1) && (isset($widget->country_code) && $widget->country_code == "US"))
                                <button type="button" class="btn-send dsgn2s11 video-send-phone" id="validate_inputs_video"><span @if(isset($widget)) style="background-color: {!! $widget->widget_buttons_bg_color !!} ; color: {!! $widget->widget_buttons_text_color !!} !important;" @endif>Send</span></button>
                            @else
                                <a href="javascript:void(0)" class="btn-send dsgn2s11 send_video_message" id="send-video" @if(isset($widget)) style="background-color: {!! $widget->widget_buttons_bg_color !!} ; color: {!! $widget->widget_buttons_text_color !!} !important;" @endif>Send</a>
                            @endif
