<div style="display: none; position: relative; overflow-x: hidden" class="display_div d3">
    ...
    <div id="popup32" class="lightbox popup32" @if(isset($widget)) style="background-color: {!! $widget->widget_bg_color !!}" @endif>
    	<section class="popup popup-four">
            ...
            <h3 @if(isset($widget)) style="color: {!! $widget->widget_text_color !!}" @endif>Recording: <span id="record_length" @if(isset($widget)) style="color: {!! $widget->widget_buttons_bg_color !!}" @endif></span></h3>
            ...
            <div class="btn-holder-r">
                <a href="javascript:void(0)" class="play btn-play-r" id="play" @if(isset($widget)) style="color: {!! $widget->widget_buttons_text_color !!} !important; display: none;" @endif><span @if(isset($widget)) style="background-color: {!! $widget->widget_buttons_bg_color !!} " @endif></span>Begin Recording</a>
